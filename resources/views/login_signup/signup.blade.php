...
<body style="background-color: #000000;">
    ...
    <nav class="navbar fixed-top navbar-expand-lg border-bottom border-warning border-3" data-bs-theme="dark"
        ...
        <div class="container-fluid mx-2">
            <div class="d-flex align-items-center">
                <img class="bg-transparent" src="/img/mamba-logo.png" style="width: 40px; height: 25px;" alt="Mamba Logo">
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="border-1 border-warning d-flex justify-content-center">
                    <img class="bg-transparent mt-5" src="img/mamba-logo.png" style="width: 100px; height: 80px;" alt="Mamba Logo">
                </div>
            </div>
            <div class="col-md-4"></div>
        </div>
        ...
        <div class="mx-auto mt-4" style="max-width: 780px; font-family: 'Times New Roman', Times, serif;">
            ...
            <form action="{{ route('signup.submit') }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                @csrf
                <!-- row 1 -->
                ...
                <div class="d-grid mt-2">
                    <button type="submit" name="signup-btn" class="btn btn-warning text-uppercase rounded-0 py-3" style="letter-spacing: 2px;">
                        Sign Up
                    </button>
                </div>
                ...
                <div class="text-center mt-4 pb-5">
                    ...
                    <a href="{{ route('login') }}" class="text-warning text-decoration-none fw-bold">Log In</a>
                </div>
            </form>
        </div>
    </div>
